...
const HeroSection = () => (
  <section className="text-center py-16 px-4 bg-gradient-to-r from-amber-100 via-white to-rose-100 rounded-2xl shadow mb-8">
    ...
    <Link to="/search" className="inline-block bg-rose-500 text-white px-6 py-3 rounded-full font-semibold shadow hover:bg-rose-600 transition">Find Inspiration</Link>
  </section>
);
