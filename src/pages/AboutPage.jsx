...
const AboutPage = () => (
  <>
    <SEO title="About Us - AceVoyager" description="Meet the travelers behind AceVoyager and learn about our mission." />
      ...
      <div className="card max-w-2xl w-full bg-base-100 shadow-xl p-0 border border-primary/10">
        <div className="card-body p-8 text-center">
          ...
          <div className="flex flex-col items-center gap-4 mb-4">
            <img src="https://placehold.co/120x120" alt="Authors" className="rounded-full w-24 h-24 object-cover border-4 border-primary/20 shadow" />
